...
class SemKITTI_nusc(data.Dataset):
    def __init__(self, nuscenes, data, return_ref=False, nusc=None):
        self.return_ref = return_ref

        self.msg_heap = []
        self.msg_heap.append(data)
...
class SemKITTI_demo(data.Dataset):
    def __init__(self, semkittiyaml, data, return_ref=True):
